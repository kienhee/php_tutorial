    ...
    <div class="row ">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12  ">
            <form action="#" class="form-control bg-secondary" method="POST">
                ...
                <div class="form-group mt-3">
                    <input class="form-control" type="number" name="number"  placeholder="Your phone number">
                </div>
                <div class="form-group mt-3">
                    <input class="form-control" type="number" name="number"  placeholder="Your website start with http:/ ">
                </div>
                <div class="mb-3">
